...
feature {NONE} -- Constant setting
	...
	frozen set_attributes_using_integer_constants
		...
		do
			...
			loop
				integer_interval_constant_retrieval_functions.item.call
				arg1 := integer_interval_constant_retrieval_functions.item.last_result
				integer_interval_constant_retrieval_functions.forth
				integer_interval_constant_retrieval_functions.item.call
				integer_interval_constant_set_procedures.item.call
					(create {INTEGER_INTERVAL}.make (arg1, integer_interval_constant_retrieval_functions.item.last_result))
				integer_interval_constant_retrieval_functions.forth
