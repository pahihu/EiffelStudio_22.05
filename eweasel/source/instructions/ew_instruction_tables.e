...
feature
	...
	test_command_table: STRING_TABLE [EW_TEST_INSTRUCTION]
		once
			...
			Result.put (create {EW_CODE_ANALYSIS_RESULT_INST}, Code_analysis_result_keyword)
			...
			Result.put (create {EW_PREFERENCE_INST}, preference_keyword)
...
note
	date: "$Date: 2019-12-12 07:09:52 -0500 (jeu 12 déc 2019) $"
	revision: "$Revision: 103746 $"
	copyright: "[
